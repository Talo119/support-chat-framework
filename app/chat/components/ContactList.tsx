            ...
            {clients.map((client) => (
              <NavLink
                ...
                className={({ isActive, isPending }) =>
                  isActive
                    ? "w-full my-2 justify-start flex items-center gap-2 bg-blue-500 transition-colors duration-200 rounded-2xl"
                    : isPending
              ...
              >
                <div
                  className={`h-6 w-6 rounded-full ${
                    id === client.id ? "bg-blue-800" : "bg-gray-300"
                ...
                <span
                  className={
                    id === client.id ? "text-white" : "text-muted-foregroundƒ"
                  }
                >
                  {client.name}
                </span>
